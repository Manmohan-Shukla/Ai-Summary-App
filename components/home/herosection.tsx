...
export default function HeroSection() {
  return (
    ...
    >
      <div className="flex">
        ...
        >
          <Badge
            ...
            bg-white rounded-full group-hover:bg-rose-300
      ...
      <h2 className="text-lg  sm:text:xl lg:text:2xl text-center px-4 lg:px-0 lg:max-w-4xltext-gray-600">
        Get a beautiful summary reel of the document in seconds
      </h2>
      <Button
        variant={"link"}
        className="text-white mt-6 text-base sm:text-lg
      lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-6 sm:py-7 
      lg:py-8 lg:mt-16 bg-linear-to-r from-slate-900 to-rose-500
      hover:from-rose-500 hover:to-slate-900 hover:no-underline font-bold
